...
public class ShowtimeController {
    ...
    @GetMapping("/admin")
    public PageResponseDTO<ShowtimeResponseDTO> getShowtimes(
        ...
        Page<ShowtimeResponseDTO> showtimes = showtimeService.getAdminShowtimes(pageable);

        return PageResponseDTO.of(showtimes);
    }

    @GetMapping("/{id}")
    public ResponseEntity<?> getShowtimeDetail(@PathVariable String id) {
        return showtimeService.getAdminShowtimeDetail(id)
